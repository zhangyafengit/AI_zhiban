...
# l1 = ["你的名字是什么", "你今年几岁了", "你有多高你胸多大", "你胸多大"] #问题
l1 = []
content = setting.MONGO_DB.contents.find()
for item in content:
    l1.append(item.get("title"))

# 14230 1675 （1，9，8，11，1，10） （1 10）
a = "我要听" # 1685 用户说的话
...
#[[(0, 1), (1, 1), (2, 1), (3, 1), (4, 1)], [(1, 1), (5, 1), (6, 1), (7, 1)], [(1, 2), (8, 1), (9, 1), (10, 1), (11, 1)], [(1, 1), (10, 1)]]
...
# DragonFire 教学专用
# [(5,5,90,90,90,90)]
# [(1,7,90,90,90,90),(4,5,45,45,135,135),(9,2,90,90,90,90),(8,1,90,90,90,90),(9,9,90,90,90,90)]
